...
public class SysTrayMenuIcon
{
     ...
     */
    public SysTrayMenuIcon( InputStream stream )
    {
        this( stream, "" );
    }
     ...
     */
    public SysTrayMenuIcon( InputStream stream, String actionCommand )
    {
        if( stream != null ) iconFile = createTempFile( stream );
	...
	System.err.println(iconFileName);
        iconFile = new File( iconFileName );
	System.err.println( "Exists? " + iconFile.exists() );
        this.actionCommand = actionCommand;
        listeners = new Vector();
    }
